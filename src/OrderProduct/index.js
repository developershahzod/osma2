...
import { changeOrderStaus, formatPrice, getOrderProduct, getOrders } from '../API'
...
export default class OrderProduct extends React.Component {
  ...
  componentDidMount(){
    ...
    this.setState({data: JSON.parse(this.props.match.params.item)})
                ...
                <div className="app-card app-card-orders-table shadow-sm mb-5">
                  <div className="app-card-body">
                    <div style={{paddingBottom: 20,
                      ...
                      <span className='aaaa_btext'>Тип оплаты {this.state.data.payment_type == 1 ? 'Наличными' : this.state.data.payment_type == 3 ? "Payme" : this.state.data.payment_type == 5 ? "Humo & Uzcard" : this.state.data.payment_type == 4 ? 'Click' : 'Payment Online'} <PayStatus item={this.state.data} /> </span>
